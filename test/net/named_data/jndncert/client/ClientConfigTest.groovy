...
class ClientConfigTest extends groovy.util.GroovyTestCase {
    void testLoad() {
        ...
        assert item.m_anchor.getName().toUri() == "/ndn/site1/KEY/%11%BC%22%F4c%15%FF%17/self/%FD%00%00%01Y%C8%14%D9%A5"
    ...
    void testExtractCaItem() {
        ...
        assert ca_item.m_anchor.getName().toUri() == "/ndn/site1/KEY/%11%BC%22%F4c%15%FF%17/self/%FD%00%00%01Y%C8%14%D9%A5"
